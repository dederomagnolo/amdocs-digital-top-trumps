...
import { HomePage, TodoPage, TopTrumps } from "./pages";
...
function Routes() {
	...
	return (
		<div className={classes.content}>
			...
			<Route exact={true} path="/top-trumps" component={TopTrumps} />
		</div>
	);
}
...
function Drawer(props: { todoList: Todo[] }) {
	...
	return (
		<div>
			...
			<List>
				<ListItem button onClick={() => history.push("/top-trumps")}>
					<ListItemText primary="Top Trumps" />
				</ListItem>
			</List>
		</div>
	);
